...
class DistEducationFilterModel extends CFormModel
{
    /**
     ...
     */
    public function getDataProvider($rawData){
        $filteredData=$this->filter($rawData);
        return new CArrayDataProvider($filteredData);
    }

    /**
     * Задать поля для фильтров
     * @param $array
     */
