...
echo '<h3 style="text-align: center">1. РЕЗЮМЕ</h3>';
...
echo CHtml::tag('strong', array('class' =>'label-field'),'Прізвище, ім`я, по батькові: ').$student->fullName;
echo CHtml::closeTag('div');
echo CHtml::openTag('div');
echo CHtml::tag('strong', array('class' =>'label-field'),'Дата народження: ').date('d.m.Y', strtotime($student->st7));
echo CHtml::closeTag('div');
echo CHtml::openTag('div');
echo printFieldValue($fieldList, $student->st1, Stportfolio::FIELD_EDUCATION_SCHOOL);
echo CHtml::closeTag('div');
echo CHtml::openTag('div');
echo CHtml::tag('strong', array('class' =>'label-field'),'Спеціальність, яку отримує у ЗВО: ').$studentInfo['pnsp2'];
echo CHtml::closeTag('div');
echo CHtml::openTag('div');
echo CHtml::tag('strong', array('class' =>'label-field'),'Освітня програма: '). $studentInfo['spc4'];
echo CHtml::closeTag('div');
echo CHtml::openTag('div');
...
echo CHtml::openTag('div');
echo CHtml::tag('strong', array(), '2.1'.'&nbsp;'.'Навчально-професійна діяльність');
...
echo CHtml::closeTag('div');
echo CHtml::openTag('div');
echo CHtml::tag('strong', array(), '2.3'.'&nbsp;'.'Дані щодо участі у заходах');
