...
foreach ($groups as $group){
    ...
    $buttonUpload = CHtml::link('<i class="icon-edit"></i>', array('uploadMarks', 'gr1'=>$group['gr1'], 'uo1'=> $model->discipline, 'chairId'=> $model->chairId), array(
        'class'=>'btn btn-success btn-mini btn-upload-marks'
    ));
