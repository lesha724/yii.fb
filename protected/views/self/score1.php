 ...
 collapse;table-layout:fixed;width:530pt">
  ...
  width:120pt">Форма №ПД-4</td>
    ...
    <tr style="height:15.0pt">
        <td colspan="39" class="xl176" style="border-right:.5pt solid black;
  ...
  border-bottom:.5pt solid black;height:147.8pt">&nbsp;</td>
    ...
    <tr style="height:15.0pt">
        <td colspan="3" class="xl156" style="height:15.0pt;border-left:none">БИК:</td>
    ...
    <tr style="height:15.0pt">
        <td colspan="3" class="xl156" style="height:15.0pt;border-left:none">КБК:</td>
  ...
  height:9.95pt">(наименование получателя платежа)</td>
    ...
    <tr style="mso-height-source:userset;height:15.0pt">
        <td class="xl114" style="height:15.0pt">&nbsp;</td>
        <td class="xl115">&nbsp;</td>
        <td class="xl115">
            <?php
  ...
  border-left:none;width:80pt"><?=$TypeScore?>% ОБУЧЕНИЯ</td>
    ...
    <tr style="height:15.75pt">
        ...
        <td class="xl115">&nbsp;</td>
        <td class="xl116">&nbsp;</td>
        <td colspan="39" rowspan="2" class="xl142" style="border-right:.5pt solid black;
  border-bottom:.5pt solid black;width:390pt">Договор: <?=$sk6?>; ФИО обучающегося: <?=Yii::app()->user->dbModel->fullName?>; ФИО плательщика: <?=$sk7?></td>
    ...
    <tr style="height:15.95pt">
        ...
        <td class="xl115">&nbsp;</td>
        <td class="xl115">
            <span style="position:absolute"><img style="float: left; " width="120px" src="<?=Yii::app()->createAbsoluteUrl('/images/image010.png')?>"></span>
        </td>
        <td class="xl115">&nbsp;</td>
        <td class="xl115">&nbsp;</td>
        <td class="xl115">&nbsp;</td>
    ...
    <tr style="height:15.75pt">
        <td height="21" class="xl114" style="height:15.75pt">
        </td>
        <td class="xl115">&nbsp;</td>
        <td class="xl115">&nbsp;</td>
        <td class="xl115">&nbsp;</td>
