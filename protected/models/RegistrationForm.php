...
class RegistrationForm extends CFormModel
{
	...
	public function rules()
	{
		return array(
            ...
            array('password', 'match', 'pattern'=>'/^[a-zA-Z][a-zA-Z0-9-_\.,]{7,}$/','message'=>tt('В password могут быть только строчные и прописные латинские буквы, цифры, спецсимволы. Минимум 8 символов')),
