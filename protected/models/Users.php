...
class Users extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('u3', 'match', 'pattern'=>'/^[a-zA-Z0-9_-]{8,30}$/','message'=>tt('В password могут быть только латинские символы и цифры, длиной от 8 до 30 символов')),
			array('u4', 'length', 'max'=>400),
            array('u2, u4', 'checkIfUnique'),
            //array('u2', 'length', 'min'=>5, 'max'=>30),
            // Логин должен соответствовать шаблону
            array('u2', 'match', 'pattern'=>'/^[a-zA-Z0-9_-]{8,30}$/','message'=>tt('В login могут быть только латинские символы и цифры,  длиной от 8 до 30 символов')),
            array('u4', 'email'),
