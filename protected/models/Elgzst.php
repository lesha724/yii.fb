...
SQL;
    ...
    {
        return array(1=>tt('без відробок (п.)'),2=>tt('по хворобі (п.)'),3=>tt('чергування (п.)'),4=>tt('інше (п.)'),5=>tt('по оплаті (н.)'),6=>tt('неизвестная причина (н.)'));
    }
    ...
    public function getTypesByGroup()
    {
        ...
        return array(
            array('id'=>6,'text'=>tt('неизвестная причина'),'group'=>tt('не поважні')),
