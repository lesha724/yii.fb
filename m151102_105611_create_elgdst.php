...
class m151102_105611_create_elgdst extends CDbMigration
{
...
SQL;
        $this->execute($sql);
        $sql = <<<SQL
ALTER TABLE elgdst ADD constraint FK_elgdst2_elgd1 FOREIGN KEY (elgdst2) REFERENCES elgd (elgd1) ON DELETE CASCADE ON UPDATE CASCADE;
SQL;
        $this->execute($sql);
        $sql = <<<SQL
...
SQL;
	...
	{
		echo "m151102_105611_create_elgdst does not support migration down.\\n";
		return false;
	}
}